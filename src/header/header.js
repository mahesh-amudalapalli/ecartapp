            ...
            <Navbar bg="light" variant="light" expand="lg" fixed="top">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mr-auto">
                        <Nav.Link as={Link} onClick={() => props.SetReadOnlyHandler(true)} className={splitLocation[1] === "home" ? "active" : ""} to='/home'>Home-Git</Nav.Link>
                        <Nav.Link as={Link} onClick={() => props.SetReadOnlyHandler(true)} className={splitLocation[1] === "aboutus" ? "active" : ""} to='/aboutus'>AboutUs-Git</Nav.Link>
